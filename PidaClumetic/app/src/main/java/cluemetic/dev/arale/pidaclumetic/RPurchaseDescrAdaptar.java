...
public class RPurchaseDescrAdaptar extends BaseAdapter {
    private ArrayList<ROnePurchaseItem> listViewItemList = new ArrayList<ROnePurchaseItem>() ;

    // ListViewAdapter의 생성자
    public RPurchaseDescrAdaptar(ArrayList<ROnePurchaseItem> listViewItemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ROnePurchaseItem listViewItem = listViewItemList.get(position);

        // 아이템 내 각 위젯에 데이터 반영
        new DownloadImageTask(iconImageView).execute(listViewItem.getImg());

        titleTextView.setText(listViewItem.getTitle());
        descTextView.setText(listViewItem.getDescr());
    ...
    public void addItem(Integer type, String img, String title, String desc, String id) {
        ROnePurchaseItem item = new ROnePurchaseItem(type, img, title, desc, id);
